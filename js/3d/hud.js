...
export function drawHUD(ctx, s, deps) {
  ...
  if (s.gameOver) {
    ...
    // --- Flowing cursorY layout to prevent text overlap (BD-250) ---
    let cursorY = 55;
    ...
    // BD-216+232: "DEFEATED BY" line with zombie tier icon and color pill (conditional)
